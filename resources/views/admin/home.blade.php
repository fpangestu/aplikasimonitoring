        ...
        <div class="row">
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
              ...
              <div class="info-box-content">
                <span class="info-box-text">Penelitian Berlangsung</span>
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
              ...
              <div class="info-box-content">
                <span class="info-box-text">Penelitian Selesai</span>
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
              <span class="info-box-icon bg-warning elevation-1"><a href="/admin/tambah_penelitian"><i class="fas fa-plus"></i></span>
              <div class="info-box-content">
                <span class="info-box-text">Penelitian Baru</span>
              </div></a>
              <!-- /.info-box-content -->
            </div>
            <!-- /.info-box -->
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header">
                  <h2 class="card-title"><a href="/admin/rincian?id={{ $p->kode_penelitian }}" class="dropdown-item">{{ $p->judul_penelitian }}</a></h2>
                  ...
                  <section class="cd-horizontal-timeline">
                          ...
                          <ol>
                            @foreach($kegiatanPenelitian as $kp)
                              @if($kp->kode_penelitian === $p->kode_penelitian)
                                <li><a href="#0" data-date="{{ date('d/m/Y', strtotime($kp->tgl_mulai)) }}">{{ date("d-m", strtotime($kp->tgl_mulai)) }}</a></li>
                              @endif
                            @endforeach
                    ...
                    <div class="events-content">
                      <ol>
                        @foreach($kegiatanPenelitian as $kp)
                          @if($kp->kode_penelitian === $p->kode_penelitian)
                            <li data-date="{{ date('d/m/Y', strtotime($kp->tgl_mulai)) }}">
                              <h2>{{ $kp-> agenda}}</h2>
