                    ...
                    <div class="col-md-9">
                        <div class="card">
                            <div class="card-header p-2">
                                ...
                                <li class="nav-item"><a class="nav-link active" href="#activity" data-toggle="tab">Komentar</a></li>
                            ...
                            <div class="card-body">
                                <div class="tab-content">
                                    <div class="active tab-pane" id="activity">
                                        @foreach($penilaianPegawai as $pp)
                                            <!-- Post -->
                                            <div class="post clearfix">
                                                <div class="user-block">
                                                    <img class="img-circle img-bordered-sm" src="{{ asset('dist/img/anonymous.png') }}" alt="user image">
                                                    <span class="username">
                                                    <a href="#">Anonymous</a>
