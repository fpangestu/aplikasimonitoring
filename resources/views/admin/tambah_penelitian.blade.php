...
@section('section')
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <form method="POST" action="/admin/tambah_penelitian/store">
        {{ csrf_field() }}
        <div class="row">
          <div class="col-md-12">
            <div class="card card-primary">
              ...
              <div class="card-body">
                <div class="form-group">
                  ...
                  <input type="text" id="namaPenelitian" name="namaPenelitian" class="form-control" placeholder="Judul Penelitian" required>
                </div>
                <div class="form-group">
                  <label for="inputDescription">Kode Penelitian</label>
                  <input type="text" id="kodePenelitian" name="kodePenelitian" class="form-control" placeholder="Format : Tahun_Kode Penelitian" required>
                </div>
                <!-- <div class="form-group">
